...
import { SegmentShape2D, CircleShape2D, RectangleShape2D, CapsuleShape2D, CollisionPolygon2D } from "@/types/resource";
...
export const ResourceCanvas = observer(
  ({
    ...
    if (resource.assetType === AssetType.RectangleShape2D) {
      const property = resource.property as ResourceProperty;
      const collision = property?.collision?.shape as unknown as RectangleShape2D;
          ...
          <Rect
            ...
            onDragMove={(e) => {
              resStore.setResourceProperty(resource.id, "transform", "position", {
                name: "position",
                type: variant.Vector2,
                value: { x: e.target.x() + size.x / 2, y: e.target.y() + size.y / 2 },
              });
            }}
            onDragStart={(e) => {
              resourceClick();
            ...
            onDragMove={(e) => {
              ...
              if (newWidth > 10 && newHeight > 10) {
                ...
                resStore.setResourceProperty(resource.id, "transform", "position", {
                  name: "position",
                  type: variant.Vector2,
                  value: { x: leftEdge + newWidth / 2, y: newY + newHeight / 2 },
                });
              }
            }}
            onDragStart={(e) => {
            ...
            onDragMove={(e) => {
              ...
              if (newWidth > 10 && newHeight > 10) {
                ...
                resStore.setResourceProperty(resource.id, "transform", "position", {
                  name: "position",
                  type: variant.Vector2,
                  value: { x: newX + newWidth / 2, y: topEdge + newHeight / 2 },
                });
              }
            }}
            onDragStart={(e) => {
            ...
            onDragMove={(e) => {
              ...
              if (newWidth > 10 && newHeight > 10) {
                ...
                resStore.setResourceProperty(resource.id, "transform", "position", {
                  name: "position",
                  type: variant.Vector2,
                  value: { x: leftEdge + newWidth / 2, y: topEdge + newHeight / 2 },
                });
              }
            }}
            onDragStart={(e) => {
