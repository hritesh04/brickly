              ...
              onChange={(e) =>
                editor.setProperty(
                  ...
                  "constant_linear_velocity",
                  {
                    ...
                    y:
                      property?.static_body_2d?.constant_linear_velocity?.y ||
                      0,
                  }
                )
              }
            ...
            <Input
              ...
              onChange={(e) =>
                editor.setProperty(
                  ...
                  {
                    x:
                      property?.static_body_2d?.constant_linear_velocity?.x ||
                      0,
      ...
      <div className="space-y-3">
        ...
        <div className="flex items-center gap-3 pl-2">
          <input
            ...
            className="w-4 h-4"
          />
          <label htmlFor="sync_to_physics" className="text-sm text-gray-600">
            Sync to Physics
          </label>
        </div>
      </div>
